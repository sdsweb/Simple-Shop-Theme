...
if ( ! class_exists( 'Simple_Shop' ) ) {
	class Simple_Shop {
		...
		function __construct() {
			...
			add_filter( 'woocommerce_page_title', array( $this, 'woocommerce_page_title' ) ); // WooCommerce - Page Title
		}
		...
		/**
		 * This function adjusts the WooCommerce page title
		 */
		public function woocommerce_page_title( $page_title ) {
			// Add the "fancy" wrapper to the page title
			$page_title = '<span class="fancy">' . $page_title . '</span>';
